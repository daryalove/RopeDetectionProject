...
namespace RopeDetectionConsoleApp
{
    public class ModelBuilder
    {
        ...
        private static string path = System.IO.Path.Combine(modelDirectory, "WpfRopeDetectionModel", "MLNETModel", "model.zip");
    ...
    searchOption: SearchOption.AllDirectories);
        ...
        private static void SaveModel(IDataView trainSet)
        {
            ...
            mlContext.Model.Save(trainedModel, trainSet.Schema, GetAbsolutePath(path));

            //mlContext.Model.Save(mlModel, modelInputSchema, GetAbsolutePath(modelRelativePath));
            Console.WriteLine("The model is saved to {0}", GetAbsolutePath(path));
        }
